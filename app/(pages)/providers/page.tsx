  ...
  return (
    <div className="mt-[200px] flex flex-col gap-20 w-[1200px]">
      <div className="flex flex-col gap-5">
        <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-slate-300 to-slate-100">Providers.</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        {providers.data.map((provider, i) => {
          return (
            <div key={i} className="border-[1px] border-foreground/20 bg-background/50 p-3 rounded-lg flex flex-col gap-3 hover:border-foreground">
              <div className="flex flex-row gap-5 items-center">
                ...
                <div className="flex flex-col gap-[2px]">
                  ...
                  <h3 className="font-extralight text-sm">{provider.data.libp2p}</h3>
                </div>
